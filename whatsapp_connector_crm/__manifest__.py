...
{
    'name': 'ChatRoom WhatsApp CRM Leads. Real All in One',
    'summary': 'From ChatRoom main view Create & Send CRM Leads. Send message from CRM Lead. All in one screen. apichat.io GupShup Chat-Api ChatApi. ChatRoom 2.0.',
